...
describe('My Login application', () => {
    ...
    it('setup a new resident', async() => {
        ...
        await newResidentPage.register('Mr', 'Test', 'Name', 'Testy', 'Male', '20/05/1987', '10', '80', '180', '20/05/2023', 'Cody Technology Park', 'Ively Rd', 'Farnborough ', 'Hampshire', 'GU14 0LX', 'UK', '0330 094 0122', 'test@everylifetechnologies.com', '07111 111111', 'Test', 'None', 'Someone', '07111 111112', 'Dr Man', 'The Surgery', '07111 111113');
